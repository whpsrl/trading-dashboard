...
const SYMBOLS = [
  // Tech Giants
  { value: 'AAPL', label: 'Apple Inc.', type: 'stock', sector: 'Technology' },
  { value: 'MSFT', label: 'Microsoft Corp.', type: 'stock', sector: 'Technology' },
  { value: 'GOOGL', label: 'Alphabet Inc. (Google)', type: 'stock', sector: 'Technology' },
  { value: 'AMZN', label: 'Amazon.com Inc.', type: 'stock', sector: 'Technology' },
  { value: 'META', label: 'Meta Platforms Inc. (Facebook)', type: 'stock', sector: 'Technology' },
  { value: 'TSLA', label: 'Tesla Inc.', type: 'stock', sector: 'Automotive' },
  { value: 'NVDA', label: 'NVIDIA Corp.', type: 'stock', sector: 'Technology' },
  { value: 'NFLX', label: 'Netflix Inc.', type: 'stock', sector: 'Entertainment' },
  
  // Finance
  { value: 'JPM', label: 'JPMorgan Chase & Co.', type: 'stock', sector: 'Finance' },
  { value: 'BAC', label: 'Bank of America Corp.', type: 'stock', sector: 'Finance' },
  { value: 'WFC', label: 'Wells Fargo & Co.', type: 'stock', sector: 'Finance' },
  { value: 'GS', label: 'Goldman Sachs Group Inc.', type: 'stock', sector: 'Finance' },
  { value: 'V', label: 'Visa Inc.', type: 'stock', sector: 'Finance' },
  { value: 'MA', label: 'Mastercard Inc.', type: 'stock', sector: 'Finance' },
  
  // Healthcare
  { value: 'JNJ', label: 'Johnson & Johnson', type: 'stock', sector: 'Healthcare' },
  { value: 'UNH', label: 'UnitedHealth Group Inc.', type: 'stock', sector: 'Healthcare' },
  { value: 'PFE', label: 'Pfizer Inc.', type: 'stock', sector: 'Healthcare' },
  { value: 'ABBV', label: 'AbbVie Inc.', type: 'stock', sector: 'Healthcare' },
  { value: 'TMO', label: 'Thermo Fisher Scientific', type: 'stock', sector: 'Healthcare' },
  
  // Consumer
  { value: 'WMT', label: 'Walmart Inc.', type: 'stock', sector: 'Retail' },
  { value: 'HD', label: 'Home Depot Inc.', type: 'stock', sector: 'Retail' },
  { value: 'DIS', label: 'Walt Disney Co.', type: 'stock', sector: 'Entertainment' },
  { value: 'NKE', label: 'Nike Inc.', type: 'stock', sector: 'Consumer' },
  { value: 'MCD', label: 'McDonald\'s Corp.', type: 'stock', sector: 'Consumer' },
  { value: 'SBUX', label: 'Starbucks Corp.', type: 'stock', sector: 'Consumer' },
  
  // Energy
  { value: 'XOM', label: 'Exxon Mobil Corp.', type: 'stock', sector: 'Energy' },
  { value: 'CVX', label: 'Chevron Corp.', type: 'stock', sector: 'Energy' },
  
  // Industrial
  { value: 'BA', label: 'Boeing Co.', type: 'stock', sector: 'Industrial' },
  { value: 'CAT', label: 'Caterpillar Inc.', type: 'stock', sector: 'Industrial' },
  { value: 'GE', label: 'General Electric Co.', type: 'stock', sector: 'Industrial' },
  
  // Telecom
  { value: 'T', label: 'AT&T Inc.', type: 'stock', sector: 'Telecom' },
  { value: 'VZ', label: 'Verizon Communications', type: 'stock', sector: 'Telecom' },
  
  // Semiconductor
  { value: 'AMD', label: 'Advanced Micro Devices', type: 'stock', sector: 'Technology' },
  { value: 'INTC', label: 'Intel Corp.', type: 'stock', sector: 'Technology' },
  { value: 'QCOM', label: 'Qualcomm Inc.', type: 'stock', sector: 'Technology' },
  
  // E-commerce & Social
  { value: 'BABA', label: 'Alibaba Group', type: 'stock', sector: 'Technology' },
  { value: 'PYPL', label: 'PayPal Holdings Inc.', type: 'stock', sector: 'Finance' },
  { value: 'SQ', label: 'Block Inc. (Square)', type: 'stock', sector: 'Finance' },
  { value: 'UBER', label: 'Uber Technologies', type: 'stock', sector: 'Technology' },
  
  // Others
  { value: 'COIN', label: 'Coinbase Global Inc.', type: 'stock', sector: 'Finance' },
  { value: 'PLTR', label: 'Palantir Technologies', type: 'stock', sector: 'Technology' },
  ...
  // === INDEX ETFs ===
  { value: 'SPY', label: 'S&P 500 ETF', type: 'etf', sector: 'Index' },
  { value: 'QQQ', label: 'NASDAQ 100 ETF', type: 'etf', sector: 'Index' },
  { value: 'DIA', label: 'Dow Jones ETF', type: 'etf', sector: 'Index' },
  { value: 'IWM', label: 'Russell 2000 ETF', type: 'etf', sector: 'Index' },
  { value: 'VTI', label: 'Total Stock Market ETF', type: 'etf', sector: 'Index' },
  { value: 'VIXY', label: 'Volatility ETF (VIX)', type: 'etf', sector: 'Index' },
  { value: 'EWJ', label: 'Japan ETF (Nikkei)', type: 'etf', sector: 'Index' },
  { value: 'EWU', label: 'UK ETF (FTSE)', type: 'etf', sector: 'Index' },
  { value: 'EWH', label: 'Hong Kong ETF', type: 'etf', sector: 'Index' },
  
  // === COMMODITY ETFs ===
  { value: 'GLD', label: 'Gold ETF', type: 'etf', sector: 'Metals' },
  { value: 'SLV', label: 'Silver ETF', type: 'etf', sector: 'Metals' },
  { value: 'PPLT', label: 'Platinum ETF', type: 'etf', sector: 'Metals' },
  { value: 'COPX', label: 'Copper Miners ETF', type: 'etf', sector: 'Metals' },
  { value: 'USO', label: 'Crude Oil ETF', type: 'etf', sector: 'Energy' },
  { value: 'BNO', label: 'Brent Oil ETF', type: 'etf', sector: 'Energy' },
  { value: 'UNG', label: 'Natural Gas ETF', type: 'etf', sector: 'Energy' },
  { value: 'UGA', label: 'Gasoline ETF', type: 'etf', sector: 'Energy' },
  { value: 'CORN', label: 'Corn ETF', type: 'etf', sector: 'Agriculture' },
  { value: 'WEAT', label: 'Wheat ETF', type: 'etf', sector: 'Agriculture' },
  { value: 'SOYB', label: 'Soybean ETF', type: 'etf', sector: 'Agriculture' },
  { value: 'JO', label: 'Coffee ETF', type: 'etf', sector: 'Agriculture' },
  { value: 'SGG', label: 'Sugar ETF', type: 'etf', sector: 'Agriculture' },
  { value: 'NIB', label: 'Cocoa ETF', type: 'etf', sector: 'Agriculture' },
];
...
export default function ChartAnalyzer() {
  ...
  // Use hardcoded stock symbols (no dynamic loading)
  useEffect(() => {
  ...
  const loadChartData = async () => {
    ...
    try {
      ...
      const endpoint = `${apiUrl}/api/v1/market-data/stock/${selectedSymbol.value}?timeframe=${selectedTimeframe.value}&limit=1000`;
